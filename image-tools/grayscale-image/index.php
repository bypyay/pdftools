<?php
$root = '../../';
$page_title = 'Black and White Image Converter Online Free | Daily1Step';
$page_description = 'Convert full color photos to aesthetic Black & White or Monochrome tone. 100% free and private.';
include __DIR__ . '/../../includes/header.php';
?>
<section class="tool-page">
  <div class="container">
    <div class="tool-header">
      <h1>Grayscale & Black/White Image</h1>
      <p>Convert full color photos to aesthetic Black & White or Monochrome tone.</p>
    </div>
...
<script src="<?php echo $root; ?>assets/js/image-tools/grayscale-image.js"></script>
