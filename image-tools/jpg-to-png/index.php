<?php
$root = '../../';
$page_title = 'JPG to PNG Converter Online Free | Daily1Step';
$page_description = 'Convert JPG pictures to lossless PNG format instantly in your browser. 100% free and private.';
...
<section class="tool-page">
  <div class="container">
    <div class="tool-header">
      ...
      <p>Convert JPG pictures to lossless PNG format instantly in your browser.</p>
    </div>
    ...
    <div class="result-box" id="resultBox">
      ...
      <a class="btn" id="downloadLink" download="converted.png">Download PNG Image</a>
...
<script src="<?php echo $root; ?>assets/js/image-tools/jpg-to-png.js"></script>
