<?php
$root = '../../';
$page_title = 'PNG to JPG Converter Online Free | Daily1Step';
$page_description = 'Convert PNG images to JPG with white background fill and quality slider. 100% free and private.';
...
<section class="tool-page">
  <div class="container">
    <div class="tool-header">
      ...
      <p>Convert PNG images to JPG with white background fill and quality slider.</p>
    </div>
...
<script src="<?php echo $root; ?>assets/js/image-tools/png-to-jpg.js"></script>
