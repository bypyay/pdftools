<?php
$root = '../../';
$page_title = 'Increase Image Size in KB Online Free | Daily1Step';
$page_description = 'Increase image file size to meet minimum KB requirements (e.g. 20KB, 50KB, 100KB) for government and recruitment forms without losing quality. 100% browser-based.';
include __DIR__ . '/../../includes/header.php';
?>
<section class="tool-page">
  <div class="container">
    <div class="tool-header">
      <h1>Increase Image Size in KB</h1>
      <p>Safely increase your image file size to satisfy minimum KB upload requirements for application forms.</p>
    </div>
    ...
    <div id="fileInfo" style="display:none; max-width:820px; margin:20px auto 0;">
      ...
      <div style="margin-top:24px; padding:22px; background:var(--bg-soft); border-radius:14px; border:1.5px solid var(--border);">
        <label style="display:block; font-weight:700; font-size:.95rem; margin-bottom:8px; color:var(--ink);">Target Minimum File Size</label>
        
        <div style="display:flex; gap:12px; align-items:center; flex-wrap:wrap; margin-bottom:14px;">
          <div style="display:flex; align-items:center; gap:8px;">
            <input type="number" id="targetKbInput" value="50" min="10" max="5000" style="width:110px; padding:10px 14px; border:1.5px solid var(--border); border-radius:8px; font-weight:700; font-size:1.1rem; color:var(--red);">
    ...
    <div class="actions" id="actions" style="display:none;">
      <button class="btn" id="increaseBtn">Increase File Size</button>
    </div>

    <div class="progress-wrap" id="progressWrap">
      <div class="progress-bar"><div id="progressBar"></div></div>
      <div class="status-text" id="statusText">Adjusting file size...</div>
    </div>

    <div class="result-box" id="resultBox">
      <div class="check">&#10003;</div>
      <h3>File Size Increased Successfully!</h3>
      <p id="resultInfo"></p>
      <a class="btn" id="downloadLink" download="increased.jpg">Download Increased Image</a>
...
<script src="<?php echo $root; ?>assets/js/image-tools/increase-image-kb.js"></script>
