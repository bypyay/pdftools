<?php
$root = '../../';
$page_title = 'WEBP to JPG Converter Online Free | Daily1Step';
$page_description = 'Convert modern WebP images to universal JPG format online. 100% free and private.';
...
<section class="tool-page">
  <div class="container">
    <div class="tool-header">
      ...
      <p>Convert modern WebP images to universal JPG format online.</p>
    </div>
...
<script src="<?php echo $root; ?>assets/js/image-tools/webp-to-jpg.js"></script>
