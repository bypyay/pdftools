<?php
$root = '../../';
$page_title = 'Delete Pages from PDF Online Free | Daily1Step PDF';
$page_description = 'Remove unwanted pages from a PDF, free and online. Click pages to mark them for deletion. Processed entirely in your browser.';
...
<section class="tool-page">
  <div class="container">
    <div class="tool-header">
      <h1>Delete Pages</h1>
      <p>Click the pages you want to remove, then download the rest as one PDF.</p>
    </div>
    ...
    <div id="fileInfo" style="display:none; max-width:820px; margin:20px auto 0;">
      ...
      <p style="margin-top:12px; font-size:.85rem; color:var(--ink-soft);">Click a page to mark it for deletion (shown in red). <span id="selectedCountText"></span></p>

      <div class="thumb-grid" id="pageThumbGrid" style="display:none; margin-top:10px;"></div>
    </div>

    <div class="actions" id="actions" style="display:none;">
      <button class="btn" id="deleteBtn">Delete Pages</button>
    </div>
    ...
    <div class="result-box" id="resultBox">
      ...
      <p id="resultInfo"></p>
      <a class="btn" id="downloadLink" download="edited.pdf">Download edited.pdf</a>
      <div style="margin-top:12px;"><button class="btn secondary" id="resetBtn">Edit another file</button></div>
    </div>
    ...
    <section class="info-section">
      ...
      <ol>
        ...
        <li>Click each page you want removed (it turns red).</li>
        <li>Click <strong>Delete Pages</strong> and download the result.</li>
      </ol>
    </section>
  </div>
</section>
...
<script src="<?php echo $root; ?>assets/js/tools/delete-pages.js"></script>
